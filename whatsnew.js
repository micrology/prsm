...
document.write(`
<li>This "What's New" panel will pop up whenever a new version of PRSM is released.  You'll only see it once.  Click the <span style="color:white;background-color:black;padding:2px;">Continue...</span> button above to dismiss it.
...
<li>A 'minimap' has replaced it.  The minimap is a minature copy of the whole map, and a rectangular outline shows the part of the map that is currently visible. This can help you see how the visible part fits into the map as a whole, if the map is very large. (If the whole map is visible, there will be no outline rectangle.) You can click anywhere on the minimap to move the visible part of the map to that location.</li>
<li>To change your name and initials, as shown on the avatar in the top right corner of the map and elsewhere, click on the avatar.  A dialog will open for you to enter your new name.</li>
<li>To open a PRSM map file (or any of the other types of file that PRSM can read), you can either use the Open button or you can now drag a file from your desktop and drop it on the PRSM browser window.</li>
