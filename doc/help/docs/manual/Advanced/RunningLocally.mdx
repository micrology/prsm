...
Maps (rooms) that are created using the containerised version are independent of those created using the usual https://prsm.uk location. You can however save the map to a PRSM file and reload the file in the other environment.
