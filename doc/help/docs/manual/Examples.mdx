...
The second is a system map about the environmental impact of the transport of goods, developed by a small group of experts working together using the app.
...
and an extract from that map showing the implications of changing the number of electric cars.
