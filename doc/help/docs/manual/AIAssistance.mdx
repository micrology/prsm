...
If the Note panel already contains text, this too is provided to the AI.  This already existing text can be used to prompt the AI and influence what it generates.
