...
function updateNodeEditor(groupId) {
	...
	elem("nodeStyleEditName").value =
		group.groupLabel !== "Sample" ? group.groupLabel : ""
	elem("nodeStyleEditFillColor").style.backgroundColor = standardizeColor(
		group.color.background
	)
	elem("nodeStyleEditBorderColor").style.backgroundColor = standardizeColor(
		group.color.border
	)
	elem("nodeStyleEditFontColor").style.backgroundColor = standardizeColor(
		group.font.color
	)
...
function updateLinkEditor(groupId) {
	...
	elem("linkStyleEditName").value =
		group.groupLabel !== "Sample" ? group.groupLabel : ""
	elem("linkStyleEditLineColor").style.backgroundColor = standardizeColor(
		group.color.color
	)
...
export function legend(warn = false) {
	...
	const namedNodeStyles = Object.keys(styles.nodes).filter(
		(key) =>
			styles.nodes[key].groupLabel && styles.nodes[key].groupLabel !== "Sample"
	)
	const namedEdgeStyles = Object.keys(styles.edges).filter(
		(key) =>
			styles.edges[key].groupLabel && styles.edges[key].groupLabel !== "Sample"
	)
